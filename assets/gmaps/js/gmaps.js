...
if (window.google && window.google.maps) {
    ...
    var GMaps = (function(global) {
        ...
        var GMaps = function(options) {
            ...
            this.hideContextMenu = function() {
                var context_menu_element = getElementById('gmaps_context_menu');
                if (context_menu_element) context_menu_element.style.display = 'none';
            };
            ...
            this.removeMarkers = function(collection) {
                ...
                for (var i = 0; i < this.markers.length; i++) {
                    if (this.markers[i] === collection[i]) this.markers[i].setMap(null);
                }

                var new_markers = [];

                for (var i = 0; i < this.markers.length; i++) {
                    if (this.markers[i].getMap() != null) new_markers.push(this.markers[i]);
                }
            ...
            this.drawOverlay = function(options) {
                ...
                if (options.auto_show != null) auto_show = options.auto_show;
            ...
            this.drawPolyline = function(options) {
                ...
                if (options.hasOwnProperty("clickable")) polyline_options.clickable = options.clickable;
            ...
            this.drawPolygon = function(options) {
                ...
                if (options.hasOwnProperty("useGeoJSON")) useGeoJSON = options.useGeoJSON;
                ...
                if (useGeoJSON == false) options.paths = [options.paths.slice(0)];
    ...
    var replace_object = function(obj, replace) {
        ...
        for (var name in replace) {
            if (obj[name] != undefined) obj[name] = replace[name];
        }
